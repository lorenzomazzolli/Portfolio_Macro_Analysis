---
title: "Macro-statistics_Health LIfe Expectancy vs Per Capita Health Expenditure"
...
# Mirror CRAN di default
options(repos = c(CRAN = "https://cloud.r-project.org"))
pkgs <- c("ggplot2","patchwork","gridExtra","ggrepel")
new <- pkgs[!(pkgs %in% installed.packages()[, "Package"])]
if(length(new)) install.packages(new, quiet = TRUE)
library(ggplot2); library(patchwork); library(gridExtra); library(ggrepel)
```


```{r linear with labels}
